...
- **Groq limitlari:** bitta toʻliq generatsiya ≈ 7k kirish token; tekin tarif 6k TPM **har model uchun alohida** → tahlil va reja `GROQ_LIGHT_MODEL=openai/gpt-oss-20b` (`llm.parse(..., light=True)`, 4–8× tezroq), prompt va review 120b. Namunalar 3 ta. Ishlab chiqarishda pullik Groq (dev tier) tavsiya — 429 boʻlsa zanjir Gemini'ga oʻtadi va sekinlashadi.
